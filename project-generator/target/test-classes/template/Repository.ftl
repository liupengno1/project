package com.joinway.${appName}.${componentName}.dao.repository;
...
import com.joinway.${appName}.data.dao.mapper.${Table}Mapper;
import com.joinway.${appName}.data.dao.repository.GenericRepository;
